...
import { ICalendarMonth, ILevelCompleteResult, IStandardLevel, Nullable } from 'db://assets/scripts/NonogramInterface';
...
import { NonogramCalendar } from 'db://assets/scripts/models/NonogramCalendar';
