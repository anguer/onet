...
import { getCache, setCache } from 'db://assets/Nonogram/scripts/utils/Cache';
...
import { ClientMessageType, ServerMessageType } from 'db://assets/Nonogram/scripts/utils/Constants';
